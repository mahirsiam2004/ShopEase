    ...
    <>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center ">
          ...
          >
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto text-blue-100 leading-relaxed">
              We’re on a mission to make premium shopping simple, joyful, and accessible to everyone — 
              one click at a time.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mt-4">From a dream to your favorite shopping destination</p>
          </motion.div>
          ...
          <div className="relative">
            ...
            {[
              { year: "2023", title: "The Beginning", desc: "ShopEase was born with a vision to simplify online shopping.", icon: Sparkles },
              { year: "2024", title: "10,000+ Customers", desc: "Reached our first major milestone with happy shoppers worldwide.", icon: Users },
              { year: "2025", title: "Expanded Categories", desc: "Launched Fashion, Home, Fitness & more — becoming a true one-stop shop.", icon: Globe },
              { year: "Today", title: "Your Trusted Partner", desc: "Continuing to grow, innovate, and put customers first — every single day.", icon: Heart },
            ].map((milestone, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`flex items-center mb-12 ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-8`}
                >
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            <motion.div variants={item} whileHover={{ y: -10 }} className="group relative bg-gradient-to-br from-blue-500 to-blue-700 text-white p-10 rounded-3xl shadow-2xl overflow-hidden">
              <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity"></div>
              <Globe className="w-16 h-16 mb-6 text-blue-200" />
              <h3 className="text-3xl font-bold mb-4">Our Mission</h3>
              <p className="text-lg leading-relaxed text-blue-100">
                To deliver a seamless, joyful shopping experience with premium products, lightning-fast delivery, and customer service that truly cares.
              </p>
              <ArrowRight className="w-8 h-8 mt-6 opacity-70 group-hover:translate-x-4 transition-transform" />
            </motion.div>

            <motion.div variants={item} whileHover={{ y: -10 }} className="group relative bg-gradient-to-br from-purple-500 to-pink-600 text-white p-10 rounded-3xl shadow-2xl overflow-hidden">
              <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity"></div>
              <Star className="w-16 h-16 mb-6 text-purple-200" />
              <h3 className="text-3xl font-bold mb-4">Our Vision</h3>
              <p className="text-lg leading-relaxed text-purple-100">
                To become the world’s most loved e-commerce platform — where quality meets affordability and every customer feels valued.
              </p>
              <ArrowRight className="w-8 h-8 mt-6 opacity-70 group-hover:translate-x-4 transition-transform" />
            </motion.div>
          </motion.div>

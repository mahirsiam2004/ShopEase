        ...
        >
          ...
          <div className="bg-white/95 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/30 p-10">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-gray-600 mt-3">Join the ShopEase family today</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                className="w-full flex items-center justify-center gap-4 bg-white border-2 border-gray-300 hover:border-blue-500 rounded-2xl py-5 px-8 font-bold text-gray-800 shadow-lg hover:shadow-xl transition-all"
              >
            ...
            <p className="text-center mt-8 text-gray-600">
              ...
              <Link href="/login" className="font-bold text-blue-600 hover:text-purple-600 transition-colors">
                Sign In
              </Link>
            </p>
          </div>
